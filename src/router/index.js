 ...
 * page — and what renders them. The generic views are the defaults: a plain
 ...
 */
export function resolveViews(config = {}) {
  return {
    home: HomeView,
    list: ListView,
    detail: DetailView,
    ...Object.fromEntries(Object.entries(config.views ?? {}).filter(([, view]) => view)),
  }
}
